...
<template>
    <div class="swiper-wrapper-container" v-if="studentopinionssection">
        ...
        <ClientOnly>
            <swiper-container ref="containerRef" dir="rtl">
                <swiper-slide v-for="(card, index) in studentopinionssection?.media" :key="index" class="custom-slide">
