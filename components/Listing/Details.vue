...
const socialMedia = ref({
  ...
  website: props.socialMedia?.website ?? "",
  video: props.socialMedia?.video ?? "",
  mail: props.socialMedia?.mail ?? "",
  phone: props.socialMedia?.phone ?? "",
});
...
<template>
  <div class="col-span-1">
    <div class="input-wrapper">
      <label class="input-label" for="Website"> {{ $t("video_url") }} </label>
      <input
        class="input"
        v-model="socialMedia.video"
        type="text"
        id="Website"
  ...
  <div class="col-span-1">
    <div class="input-wrapper">
      <label class="input-label" for="Website"> {{ $t("phone") }} </label>
      <input
          class="input"
          type="text"
          inputmode="numeric"
          id="phone_number"
          v-model="socialMedia.phone"
          placeholder="(xxx) xxx-xxxx "
          pattern="[0-9]{10}"
          required
      />
<!--      <GlobalInputphone @update:phoneNumber="socialMedia.phone = $event" />-->
    </div>
  </div>
  <div class="col-span-1">
    <div class="input-wrapper">
      <label class="input-label" for="Website"> {{ $t("Website") }} </label>
      <input
        class="input"
  ...
  <div class="col-span-1">
    <div class="input-wrapper">
      <label class="input-label" for="mail"> {{ $t("mail") }} </label>
      <input
        class="input"
        v-model="socialMedia.mail"
        type="text"
        id="Website"
