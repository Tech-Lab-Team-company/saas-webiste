    ...
    <nav class="container mx-auto px-8">
      <div class="nav-wrapper flex items-center justify-between">
        ...
        <div class="links">
          ...
          <div class="dropdown">
            <span class="dropdown-trigger">{{ $t("categories") }}
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_61_564)">
                  <path d="M11.06 5.72656L8 8.7799L4.94 5.72656L4 6.66656L8 10.6666L12 6.66656L11.06 5.72656Z"
                    fill="black" />
                </g>
                <defs>
            ...
            <ul class="dropdown-content">
              <li class="dropdown-item" v-for="category in categories" :key="category.id">
                <button class="sub-category" v-if="category.sub_categories.length > 0"
                  @click="toggleSubCategory(category.id)" :class="{ active: showChildrenStates[category.id] }">
                  ...
                  <ul class="sub-category-list" v-if="
                    showChildrenStates[category.id] &&
                    category.sub_categories.length > 0
                  ">
                    <li v-for="subCategory in category.sub_categories" @click="setSubCategory(subCategory.id)">
