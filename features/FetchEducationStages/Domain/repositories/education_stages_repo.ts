...
import { EducationStagesApiService } from "../../Data/api_services/education_stage_api_services";
// import UserModel from "../../Data/models/education_stages_model";
import  TitleModel from "~/base/core/Models/title_model";

class EducationStagesRepo extends RepoInterface<TitleModel[]> {
  private static instance: EducationStagesRepo;
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new EducationStagesRepo();
    }
  ...
  get serviceInstance(): ServicesInterface {
    return EducationStagesApiService.getInstance();
  }
}

export { EducationStagesRepo };
